...
struct Error *FUNCTION_NAME ## resize(struct STRUCT_NAME *buffer, size_t size) NODISCARD;
#define DECLARE_BUFFER_RESERVE(TYPE, STRUCT_NAME, FUNCTION_NAME) \
struct Error *FUNCTION_NAME ## reserve(struct STRUCT_NAME *buffer, size_t capacity) NODISCARD;
#define DECLARE_BUFFER_APPEND(TYPE, STRUCT_NAME, FUNCTION_NAME) \
struct Error *FUNCTION_NAME ## append(struct STRUCT_NAME *buffer, const TYPE *data, size_t size) NODISCARD;
#define DECLARE_BUFFER_PUSH(TYPE, STRUCT_NAME, FUNCTION_NAME) \
struct Error *FUNCTION_NAME ## push(struct STRUCT_NAME *buffer, TYPE data) NODISCARD;
