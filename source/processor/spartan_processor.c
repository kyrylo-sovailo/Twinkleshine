    ...
    struct ConstantContinuousValue *response_stream)
{
    switch (fixed)
    {
    case FR_MAX_CLIENTS:                    response_stream->p = "5 Maximum number of clients reached" CRLF;        break;
    case FR_MAX_MEMORY:                     response_stream->p = "5 Maximum memory usage reached" CRLF;             break;
    case FR_MAX_UTILIZATION:                response_stream->p = "5 Maximum processor utilization reached" CRLF;    break;
    case FR_UNKNOWN:                        response_stream->p = "5 Unknown error" CRLF;                            break;
    ...
    default:                                response_stream->p = "5 Unknown error" CRLF;                            break;
    }
