...
struct Error *server_initialize(struct PollBuffer *polls)
{
    ...
    const char **http_mode, **https_mode, **gopher_mode, **finger_mode, **gemini_mode, **spartan_mode, **nex_mode;
    ...
    PRET(server_create_socket_pair(polls, &spartan_mode, SPARTAN_PORT));
